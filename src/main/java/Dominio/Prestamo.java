...
public class Prestamo {
    ...
    public double getImporte_pagar_por_mes() { return importe_pagar_por_mes; }
    public void setImporte_pagar_por_mes(double importe_pagar_por_mes) { this.importe_pagar_por_mes = importe_pagar_por_mes; }
    public int getPlazo_pago_meses() { return plazo_pago_meses; }
    public void setPlazo_pago_meses(int plazo_pago_meses) { this.plazo_pago_meses = plazo_pago_meses; }
